...
\newfontfamily\dvhero{Mukta-ExtraBold.ttf}[Script=Devanagari,Scale=1.15]
\newfontfamily\dvbold{Mukta-Bold.ttf}[Script=Devanagari,Scale=1.3]
\newfontfamily\dvsemi{Mukta-SemiBold.ttf}[Script=Devanagari,Scale=1.3]
\newfontfamily\dv{Mukta-Medium.ttf}[Script=Devanagari,Scale=1.3]
...
\node[rotate=90,anchor=center,text=ink,font=\uiBlack\fontsize{11.5}{12}\selectfont,inner sep=0]
  at (4.9,131) {\dvbold RBSE \ \textbullet\ \ कक्षा 12 \ \textbullet\ \ सत्र 2026–27 \ \textbullet\ \ बोर्ड परीक्षा 2027 \ \textbullet\ \ हिंदी माध्यम};

% =================== HEADER ===================
\fill[ink2] (0,262) rectangle (210,297);
\fill[gold] (0,261.2) rectangle (210,262.6);
\fill[goldD] (0,260) rectangle (210,260.6);
\node[anchor=center] at (24,279.5) {\includegraphics[width=27mm]{assets/sfc_logo.png}};
...
\node[fill=gold,rounded corners=2mm,inner xsep=3mm,inner ysep=1.6mm,anchor=east,text=ink,font=\uiBlack\fontsize{10}{11}\selectfont] at (203,285) {\dvbold हिंदी माध्यम};
\node[draw=gold,rounded corners=2mm,inner xsep=3mm,inner ysep=1.5mm,anchor=east,text=goldL,font=\uiBold\fontsize{9.5}{11}\selectfont,line width=.6pt] at (203,272.5) {\dvbold प्रश्न बैंक};

% =================== HERO ===================
\pill{18}{246}{gold}{ink}{\dvbold RBSE \ \textbullet\ \ कक्षा 12 \ \textbullet\ \ NCERT पंक्ति-दर-पंक्ति}
\node[fill=ink,draw=gold,line width=.6pt,rounded corners=2.2mm,inner xsep=3.2mm,inner ysep=1.5mm,anchor=west,text=goldL,font=\uiBold\fontsize{10.5}{12}\selectfont] at (114mm,246mm) {\dvbold बोर्ड परीक्षा 2027};
% PHYSICS  (resized to a fixed width so it can never overflow)
\node[anchor=south west,inner sep=0,text=white] at (17,197) {\dvhero\resizebox{152mm}{!}{भौतिक विज्ञान}};
% BLACK BOOK
\node[anchor=south west,inner sep=0,text=gold] at (17.5,174.5) {\dvhero\resizebox{84mm}{!}{ब्लैक बुक}};
...
\node[fill=gold,rounded corners=1.2mm,inner xsep=3.6mm,inner ysep=1.9mm,anchor=west,rotate=-1.5,
      text=ink,font=\hook\fontsize{19}{20}\selectfont] at (18,163) {\dvhero “इसके बाहर कुछ नहीं!”};
% the buy line
\node[anchor=west,text=white,font=\hook\fontsize{15}{16}\selectfont,inner sep=0] at (18.5,150.5)
  {\dvhero जो पेपर में आएगा, \textcolor{goldL}{यहीं से आएगा।}};

% =================== STAT TILES ===================
\stat{18}{111}{16}{\dvbold वर्षों के PYQ}{\dv RBSE 2011–2026, वर्ष सहित}
\stat{78}{111}{100\%}{\dvbold NCERT पंक्ति-दर-पंक्ति}{\dv हर पंक्ति, सारणी व चित्र}
\stat{138}{111}{1}{\dvbold किताब। पूरे अंक।}{\dv हर उत्तर इसी में}

% =================== CHAPTER ICONS ===================
\iconring{30}{78}{\dvsemi विद्युत}{%
...
\iconring{60}{78}{\dvsemi चुंबकत्व}{%
...
\iconring{90}{78}{\dvsemi प्रत्यावर्ती धारा}{%
...
\iconring{120}{78}{\dvsemi प्रकाशिकी}{%
...
\iconring{150}{78}{\dvsemi परमाणु एवं नाभिक}{%
...
\iconring{180}{78}{\dvsemi अर्धचालक}{%
...
% author
\node[anchor=center] at (30,24) {\includegraphics[width=33mm]{assets/nk_sir.png}};
\draw[gold,line width=1.6pt] (30,24) circle (17);
\node[anchor=west,text=goldL,font=\uiBold\fontsize{9.5}{10}\selectfont,inner sep=0] at (52,34) {\dvbold लेखक};
\node[anchor=west,text=white,font=\hero\fontsize{21}{22}\selectfont,inner sep=0] at (52,26.5) {\dvhero नानूराम कुमावत};
\node[anchor=west,text=gold,font=\hook\fontsize{13}{14}\selectfont,inner sep=0] at (52.3,17.5) {\dvbold (NK सर)};
\node[anchor=west,text=mist,font=\hookLight\fontsize{9.5}{10}\selectfont,inner sep=0] at (52.3,10.5) {\dv सीखो \ \textbullet\ \ अभ्यास करो \ \textbullet\ \ स्कोर करो};
...
\end{scope}
\node[anchor=west,text=mist,font=\ui\fontsize{8.5}{9}\selectfont,inner sep=0] at (147,34.2) {\dv व्हाट्सऐप};
...
\end{scope}
\node[anchor=west,text=mist,font=\ui\fontsize{8.5}{9}\selectfont,inner sep=0] at (147,19.2) {\dv यूट्यूब};
